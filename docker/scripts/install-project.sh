...
echo "
*******************************************************************************
		Zur Installation sind noch 3 Schritte notwendig:
-------------------------------------------------------------------------------"
echo "1. Bitte die Variablen für die Docker-Umgebung anpassen
-------------------------------------------------------------------------------"
cd docker
...
echo "
-------------------------------------------------------------------------------
2. Docker Container erstellen, Init-Container ausführen
-------------------------------------------------------------------------------"
...
echo "
--------------------------------------------------------------------------------
3. weitere Dateien anlegen"
# TODO: Was ist mit .env.local von Symfony und dem Anlegen von weiteren Werten?
echo "*******************************************************************************"
printf "%*s\n" $[40] "$PROJECT_NAME" # center name

echo "                 wurde erfolgreich installiert
*******************************************************************************
start mit
