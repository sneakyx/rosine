...
INSERT INTO rosine_offers_positions SELECT a.ANGEBOTID, a.ANGEBOTPOSID, a.POSITIONID, a.POS_MENGE, p.POS_EINHEIT, (a.POS_PREIS / 1.19), p.POS_LAGER, a.POS_SERIENNR, a.POS_TEXT, p.POS_MWST, "J" FROM rothaar_angebotpos AS a JOIN rothaar_position AS p ON a.POSITIONID = p.POSITIONID WHERE 1;
...
INSERT INTO rosine_invoices_positions SELECT r.RECHNUNGID, r.VERKAUFID, r.POSITIONID , r.POS_MENGE, p.POS_EINHEIT, (r.POS_PREIS / 1.19), p.POS_LAGER, r.POS_SERIENNR, r.POS_TEXT, p.POS_MWST, 1 FROM rothaar_verkauf AS r JOIN rothaar_position AS p ON r.POSITIONID = p.POSITIONID WHERE 1;
